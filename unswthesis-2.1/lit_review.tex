...
This involved segmenting the hand from the image at a specified depth range of 250-650mm, removing the noise and background from the image and converting the RGB into a solid black and white outline, as shown in Figure~\ref{fig:hand_gestures}.
